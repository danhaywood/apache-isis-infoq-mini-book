...
== Object identity (link:https://github.com/danhaywood/gymclass/tree/2.2-exception-recognizer-for-Person-duplicates[2.2^])
...
== Paraname8 addon (link:https://github.com/danhaywood/gymclass/tree/2.3-paraname8[2.3^])
