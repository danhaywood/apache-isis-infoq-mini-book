...
== Using the maven archetype to generate the app [link:https://github.com/danhaywood/gymclass/tree/_1.1-as-generated-by-simpleapp-archetype[_1.1^]]
...
== Refactor [link:https://github.com/danhaywood/gymclass/tree/_1.2-simple-module-refactored-to-person-module[_1.2^]]
