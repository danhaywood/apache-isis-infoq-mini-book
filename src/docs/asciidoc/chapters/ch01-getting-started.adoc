...
In addition, metadata can be provided which relates to the preeentation layer.
...
.What's missing?
****
You may have noticed that there was no discussion of `SimpleObjectController` or `SimpleObject.html` views.
...
Reenskaug, Pawson thesis, naked objects pattern.
****
